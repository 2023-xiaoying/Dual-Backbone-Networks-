...
class ConfigS3DIS:
    ...
    sub_grid_size = 0.50  # preprocess_parameter
...
class Multi_PSD:
    ...
    encoder_num_kernels = 9
    decoder_num_kernels = 6
    num_layers = 5  # Number of layers
    num_points = 4096 * 10  # Number of input points
    num_classes = 6  # Number of valid classes
    sub_grid_size = 0.5  # preprocess_parameter
    ...
    d_out = [16, 64, 128, 256, 512]  # feature dimension
    noise_init = 3.5  # noise initial parameter
    max_epoch = 150  # maximum epoch during training
    learning_rate = 1e-3  # initial learning rate
    lr_decays = {i: 0.95 for i in range(0, 500)}  # decay rate of learning rate
    train_sum_dir = 'my_train_log_port_11-10'
    saving = True
    saving_path = None
...
class Multi_spec:
    # model_path = 'results/Log_2022-11-06_PSD_port'
    k_n = 16  # KNN 16

    encoder_num_kernels = 9
    decoder_num_kernels = 9
    num_layers = 5  # Number of layers
    num_points = 4096 * 10  # Number of input points
    num_classes = 6  # Number of valid classes
    sub_grid_size = 0.5  # preprocess_parameter
...
class Multi_spec_conv:
    # model_path = 'results/Log_2022-11-06_PSD_port'
    k_n = 16  # KNN 16
    decoder_num_idx = 9
    encoder_num_kernels = 6
    decoder_num_kernels = 6
    num_layers = 5  # Number of layers
    num_points = 4096 * 16  # Number of input points
    num_classes = 6  # Number of valid classes
    sub_grid_size = 0.5  # preprocess_parameter
    batch_size = 2  # batch_size during training
    val_batch_size = 2  # batch_size during validation and test
    ...
    saving = True
    saving_path = None
    training_ep0 = {i: 0 for i in range(0, 1)}
    training_ep = {i: np.exp(i / 100 - 1.0) for i in range(0, 101)}
    training_ep.update(training_ep0)
    c_epoch = 0
    topk = 500
    ignored_label_inds = [0]
...
class Multi_spec_Guan:
    # model_path = 'results/Log_2022-11-06_PSD_port'
    k_n = 16  # KNN 16
    decoder_num_idx = 9
    # encoder_num_kernels = 9
    decoder_num_kernels = 5
    num_layers = 5  # Number of layers
    num_points = 4096 * 10  # Number of input points
    num_classes = 6  # Number of valid classes
    sub_grid_size = 0.5  # preprocess_parameter
...
class DataProcessing:
    ...
    def get_dataset_root_path():
        ...
        elif user_name == 'chenke':
            root_path = '/home/chenke/桌面/chengzi/data'
        elif user_name == 'hello':
            root_path = '/media/hello/76FCB52FFCB4EB0F/data'
        else:
