import pickle, os, sys, glob, getpass, argparse
import numpy as np
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_path', type=str, default='/home/chenke/桌面/DATA1',
                        help='the number of GPUs to use [default: 0]')
    FLAGS = parser.parse_args()
    dataset_path = '/media/hello/76FCB52FFCB4EB0F/data/port'
    ...
    original_pc_folder = '/media/hello/76FCB52FFCB4EB0F/data/port/original_ply'
    ...
    for sample_type in preparation_types:
        for pc_path in files:
            ...
            if cloud_typy == '.txt':
                ...
                out_folder = join('/media/hello/76FCB52FFCB4EB0F/data/port/SQN_Port', sample_type + '_{:.3f}'.format(grid_size))
