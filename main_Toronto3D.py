...
from tool import Toronto3D_conv as cfg
...
if __name__ == '__main__':
    ...
    parser.add_argument('--labeled_point', type=str, default='1%', help='0.1%/1%/10%/100%')
    ...
    if Mode == 'train':
        ...
        snap_path = join('results/SQN_Conv_Log_2024-01-12_Toronto_3D', 'snapshots') # 三重线性插值 75.03
